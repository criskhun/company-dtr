            ...
            <div class="box-header with-border">
              <div class="pull-right">
                <form method="POST" class="form-inline" id="payForm">
                  ...
                  <button type="button" class="btn btn-success btn-sm btn-flat" id="payroll"  target="_blank"><span class="glyphicon glyphicon-print"></span> Admin Payroll</button>
                  <button type="button" class="btn btn-primary btn-sm btn-flat" id="payslip"  target="_blank"><span class="glyphicon glyphicon-print"></span> Payslip</button>
                </form>
              </div>
            </div>
            <div class="box-body">
