          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered">
                ...
                <tbody>
                  <?php
                    $sql = "SELECT *, undertime.id AS otid, employees.employee_id AS empid FROM undertime LEFT JOIN employees ON employees.id=undertime.employee_id ORDER BY date_undertime DESC";
                    $query = $conn->query($sql);
                    while($row = $query->fetch_assoc()){
                      echo "
                        <tr>
                          <td class='hidden'></td>
                          <td>".date('M d, Y', strtotime($row['date_undertime']))."</td>
                          <td>".$row['empid']."</td>
